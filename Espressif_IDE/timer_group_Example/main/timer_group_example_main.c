...
#include "driver/timer.h"	// this include needed
#include "sdkconfig.h"

#define TIMER_DIVIDER         (16)  //  Hardware timer clock divider
#define TIMER_BASE_CLOCK      (80*1000000)
#define TIMER_SCALE           (TIMER_BASE_CLOCK / TIMER_DIVIDER)  // convert counter value to seconds
