...
void loop() {
  ...
  else if(currentMillis - previousMillis[1] >= 100)
  {
    ...
    tft_printf(0, 150, "CP:%6d", as5600_cumulativePosition);
    tft_printf(0, 180, "RPM:%5.1f", filteredRPM);
  }
  else if (currentMillis - previousMillis[2] >= 10) { // Update every 500ms
    previousMillis[2] = currentMillis;
    button_tick();
  }
  else if (currentMillis - previousMillis[3] >= 3) { // Update every 5ms
