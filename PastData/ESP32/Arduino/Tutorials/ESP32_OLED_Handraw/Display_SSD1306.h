...
class Display_SSD1306 { // : public Adafruit_GFX {
 public:
  Display_SSD1306(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS);
  Display_SSD1306(int8_t DC, int8_t RST, int8_t CS);
  Display_SSD1306(int8_t RST = -1);
