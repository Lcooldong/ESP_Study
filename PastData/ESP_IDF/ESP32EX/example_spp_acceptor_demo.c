...
//static char my_input[MY_BUFF_SIZE];
...
// copy bluetooth input to static char
//		memset(my_input, 0, MY_BUFF_SIZE);
//		memcpy(my_input, param->data_ind.data, MY_BUFF_SIZE -1);
//		strcpy(my_input, param->data_ind.data);
		my_input = *(param->data_ind.data);
